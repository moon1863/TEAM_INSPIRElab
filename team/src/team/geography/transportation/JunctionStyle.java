 ...
 *
 */
public class JunctionStyle implements MarkStyle<Junction>{
	 ...
	 */
	@Override
	public PlaceMark getPlaceMark(Junction agent, PlaceMark mark) {
	 ...
	 */
	@Override
	public double getElevation(Junction agent) {
			return 0;
	}
	 ...
	 */
	@Override
	public WWTexture getTexture(Junction agent, WWTexture texture) {
	
		// WWTexture is null on first call.
	
		switch(agent.getSelected()) {
		case 0:return textureMap.get("blue circle");
		case 1:return textureMap.get("yellow circle");
		case 2:return textureMap.get("green circle");
	 ...
	 */
	@Override
	public double getScale(Junction agent) {
		return 0.2;
	}

	@Override
	public double getHeading(Junction agent) {
		return 0;
	}
	 ...
	 */
	@Override
	public String getLabel(Junction agent) {
//		return "" + agent.getWaterRate();
		return null;
	}

	@Override
	public Color getLabelColor(Junction agent) {
		return Color.YELLOW;
	}
	 ...
	 */
	@Override
	public Offset getLabelOffset(Junction agent) {
		return labelOffset;
	}

	@Override
	public Font getLabelFont(Junction obj) {
		return null;
	}
	 ...
	 */
	@Override
	public double getLineWidth(Junction agent) {
		return 2;
	}

	@Override
	public Material getLineMaterial(Junction obj, Material lineMaterial) {
	...
	@Override
	public Offset getIconOffset(Junction obj) {
