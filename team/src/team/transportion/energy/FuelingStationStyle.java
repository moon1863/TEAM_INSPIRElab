...
public class FuelingStationStyle implements MarkStyle<FuelingStation>{
	
	private Offset labelOffset;
	private Offset iconOffset;
	private Map<String, WWTexture> textureMap;
	
	public FuelingStationStyle(){
		...
		File f = new File("data/image/charging_station_blue.png");
		...
		textureMap.put("blue station", new BasicWWTexture(image));
		
		f = new File("data/image/charging_station_red.png");
		...
		textureMap.put("red station", new BasicWWTexture(image));
	 ...
	 */
	@Override
	public PlaceMark getPlaceMark(FuelingStation agent, PlaceMark mark) {
	 ...
	 */
	@Override
	public double getElevation(FuelingStation agent) {
		return 0;
	}
	 ...
	 */
	@Override
	public WWTexture getTexture(FuelingStation station, WWTexture texture) {
		return textureMap.get("red station");
	}
	 ...
	 */
	@Override
	public double getScale(FuelingStation agent) {
		return 0.05;
	}

	@Override
	public double getHeading(FuelingStation agent) {
		return 0;
	}
	 ...
	 */
	@Override
	public String getLabel(FuelingStation agent) {
		String tripPurp = "";
		
		return "" + tripPurp; //+ "; \n Battery: " + (int) Math.round(agent.getEnergyRem()) + "kWh";
	}

	@Override
	public Color getLabelColor(FuelingStation agent) {
		return Color.WHITE;
	}
	 ...
	 */
	@Override
	public Offset getLabelOffset(FuelingStation agent) {
		return labelOffset;
	}

	@Override
	public Font getLabelFont(FuelingStation obj) {
		return null;
	}
	 ...
	 */
	@Override
	public double getLineWidth(FuelingStation agent) {
		return 0;
	}

	@Override
	public Material getLineMaterial(FuelingStation obj, Material lineMaterial) {
	...
	@Override
	public Offset getIconOffset(FuelingStation obj) {
		return iconOffset;
	}
}
