...
*
*/
public class VehicleStyle implements MarkStyle<Vehicle>{
	...
	public VehicleStyle(){
		...
		File f = new File("data/image/ev_green.png");
		...
		textureMap.put("ev_green", new BasicWWTexture(image));
		
		f = new File("data/image/ev_yellow.png");
		...
		textureMap.put("ev_yellow", new BasicWWTexture(image));
		
		f = new File("data/image/ev_red.png");
		...
		textureMap.put("ev_red", new BasicWWTexture(image));
		
		f = new File("data/image/ev_empty.png");
		...
		textureMap.put("ev_empty", new BasicWWTexture(image));
	 ...
	 */
	@Override
	public PlaceMark getPlaceMark(Vehicle agent, PlaceMark mark) {
	 ...
	 */
	@Override
	public double getElevation(Vehicle agent) {
			return 0; //TODO elevation?
	}
	 ...
	 */
	@Override
	public WWTexture getTexture(Vehicle agent, WWTexture texture) { // return null for not display
	
		double remainRatio = agent.getRemainMileAge().num / agent.getMileAge().num;
		if (remainRatio < 0d) {
			return textureMap.get("ev_empty");
		} else if (remainRatio < 0.3d) {
			return textureMap.get("ev_red");
		} else if (remainRatio < 0.7d) {
			return textureMap.get("ev_yellow");
		} else {
			return textureMap.get("ev_green");
		}
	}
	 ...
	 */
	@Override
	public double getScale(Vehicle agent) {
			return 0.20;
	}

	@Override
	public double getHeading(Vehicle agent) {
		return 0;
	}
	

	@Override
	public String getLabel(Vehicle agent) {
		String tripPurp = "";
		//TODO add Vehicle purpose content
		return "" + tripPurp;
	}

	@Override
	public Color getLabelColor(Vehicle agent) {
		return Color.WHITE;
	}
	 ...
	 */
	@Override
	public Offset getLabelOffset(Vehicle agent) {
		return labelOffset;
	}

	@Override
	public Font getLabelFont(Vehicle obj) {
		return null;
	}
	 ...
	 */
	@Override
	public double getLineWidth(Vehicle agent) {
			return 0;
	}

	@Override
	public Material getLineMaterial(Vehicle obj, Material lineMaterial) {
	...
	@Override
	public Offset getIconOffset(Vehicle obj) {
		return iconOffset;
	}
}
